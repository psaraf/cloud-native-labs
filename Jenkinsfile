            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user6') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user6/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user6') {
                    ...
                    openshift.tag("user6/gateway-canary:latest", "user6/gateway:latest")
